...
for (const p of POOLS) {
  for (let i = 1; i <= 5; i++) {
    ...
    review.passages.push({
      ...
      type: 'moji_mondai1',
      questions: generateQuestions('moji1', 2, 'm_' + idPrefix + '_m1')
    });
    review.passages.push({
      id: 'p_' + idPrefix + '_moji2',
      type: 'moji_mondai2',
      questions: generateQuestions('moji2', 2, 'm_' + idPrefix + '_m2')
    });
    review.passages.push({
      id: 'p_' + idPrefix + '_moji3',
      type: 'moji_mondai3',
      questions: generateQuestions('moji3', 2, 'm_' + idPrefix + '_m3')
    });
    review.passages.push({
      id: 'p_' + idPrefix + '_bunpou1',
      type: 'mondai1',
      questions: generateQuestions('bunpou1', 3, 'm_' + idPrefix + '_b1')
    });
    review.passages.push({
